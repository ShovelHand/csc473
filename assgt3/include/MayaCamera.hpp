...
public:
	...
	atlas::math::Matrix4 getDollyMatrix();
	atlas::math::Matrix4 getTrackMatrix();
	atlas::math::Matrix4 getTumbleMatrix();

	void setDollyMatrix(atlas::math::Matrix4 mat);
	void setTrackMatrix(atlas::math::Matrix4 mat);
	void setTumbleMatrix(atlas::math::Matrix4 mat);
