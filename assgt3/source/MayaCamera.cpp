...
atlas::math::Matrix4 MayaCamera::getDollyMatrix()
{
	return mImpl->dollyMatrix;
}

atlas::math::Matrix4 MayaCamera::getTrackMatrix()
{
	return mImpl->trackMatrix;
}

atlas::math::Matrix4 MayaCamera::getTumbleMatrix()
{
	return mImpl->tumbleMatrix;
}

void MayaCamera::setDollyMatrix(atlas::math::Matrix4 mat)
{
	mImpl->dollyMatrix = mat;
}

void MayaCamera::setTrackMatrix(atlas::math::Matrix4 mat)
{
	mImpl->trackMatrix = mat;
}

void MayaCamera::setTumbleMatrix(atlas::math::Matrix4 mat)
{
	mImpl->tumbleMatrix = mat;
}

atlas::math::Vector MayaCamera::getTrackVector(){ return mImpl->trackVector; }